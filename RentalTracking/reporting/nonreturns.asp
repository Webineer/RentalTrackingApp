...
<div align="right">
<form method="POST" action="nonreturns_excel.asp" name="excelForm" target="_blank">
<input type="hidden" name="DateEnd" value="<%=Request.Form("DateEnd") %>">
<input type="submit" value="Print This Report">
</form>
</div>
...
'Check to see if the equipment is already in the database
	...
	'RecipientMail = "gregscarfo@comcast.net"
	'Call SendEmail(RecipientName, Message, RecipientMail)
%>
<!-- /table -->
