...
//do list reservations that match the search criterion in the POST collection
	...
	//Get the total number of reservations for this time period
       ...
       $sql_string7 = $sql_string7 . "products.product_name = '" . $_POST['product_name'] . "' and ";
       $sql_string7 = $sql_string7 . "products.product_type = '" . $_POST['product_type'] . "' and ";
       $sql_string7 = $sql_string7 . "reservations.reservation_date <= '" . convert_date_input($_POST['end_date']) . "' and reservations.reservation_date >= '" . convert_date_input($_POST['begin_date']) . "'";
...
?>
        ...
        <tr>
            <td>
                <h2><?php print $_POST['product_name']; ?></h2>
                <h2><?php print $_POST['product_type']; ?></h2>
                <h2><?php print $_POST['begin_date'] ?> - <?php print $_POST['end_date']; ?></h2>
            </td>
            <td>
...
<?php
   ...
   //Get list of the reservations that meet this search criteria     
       ...
       $sql_string = $sql_string . "products.product_name = '" . $_POST['product_name'] . "' and ";
       $sql_string = $sql_string . "products.product_type = '" . $_POST['product_type'] . "' and ";
       $sql_string = $sql_string . "reservations.reservation_date <= '" . convert_date_input($_POST['end_date']) . "' and reservations.reservation_date >= '" . convert_date_input($_POST['begin_date']) . "'";
       //print $sql_string . "<br>";
