...
<p>To confirm an assignment, please use this <a href="index.php">form</a> to review instructor assignments.</p>
...
<?php       
                ...
                print "<p class=\"warning_red\">No section associated with this barcode.</p>";
            }        
        } elseif ($_POST['section_type'] == "h") {
            
            //test to see if this helper barcode exists in the helper_setions table
            $sql_string10 = "select id from helper_sections where section_id = " . $_POST['section_id'];
            //print $sql_string9 . "<br>";
            $helper_info = get_one_row_data_array_generic_sql($sql_string10);
            list($helper_id) = $helper_info;
            //print "the program id is " . $program_id . "<br>";
            
            //if helper_id exists, use it in the helper_barcodes table to document a helper assignment for this instructor id
            if (isset($helper_id)) {
                //enter into program_barcodes table to be added to the salary reports    
                $table_name = "helper_barcodes";
                $field_names = array("helper_barcode", "instructor_id", "helper_date");
                ...
                print "<p>A helper (barcode) assignment to this instructor completed.</p>";
            } else {
                //tell user that this barcode is not correct
                print "<p class=\"warning_red\">No such helper barcode.  Please check the barcode.</p>";
            }
		...
		print "<p>No section id provided.</p>";
	}
/*	
...
*/
	require("../../lib/forms/sections_assignment_by_date_form.php");
?>
