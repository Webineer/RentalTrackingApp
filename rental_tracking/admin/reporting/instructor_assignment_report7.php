...
<div align="center"><?php require("../../lib/forms/instructor_report_form.php"); ?></div>
<div align="center">
 <?php
   ...
   print "<th>L</th><th>P</th><th>PR</th><th>H</th><th>Total</th></tr>";
    ...
    foreach($instructor_id_hash_array as $key => $value1) {
        ...
        foreach($the_date_array as $value2) {
            ...
            //while ($row) {
                ...
                //$employee_num_helper_week_total = intval($employee_num_helper_week_total) + intval($row7[0]);  
    ...
    $grand_total = $grand_private_total + $grand_private_request_total + $grand_lesson_program_total + $grand_helper_total;
