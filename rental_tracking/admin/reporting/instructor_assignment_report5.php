   ...
   print "<th>Total</th></tr>";
    ...
    foreach($instructor_id_hash_array as $key => $value1) {
        ...
        foreach($the_date_array as $value2) {
            ...
            //$j=0;
            //foreach ($helper_id_hash_array as $key => $value4) {
            //    $sql_string7 =  "select count(id) from helper_barcodes where instructor_id = " . $value1 . " and helper_date ='" . $value2 . "' and helper_barcode =" . $key;
            //    //print $sql_string7 . "<br>";
            //    $res7[$j] = view_data_generic_sql($sql_string7); 
            //    $row7[$j] = $res7[$j]->fetchRow();
            //    $j = $j+1;
            //}
            ...
            //while ($row) {
                ...
                $temp_write_buffer .= "<td><div align=center>" . (intval($row2[0]) + intval($row6[0])) . "&nbsp;&nbsp;|&nbsp;&nbsp;" . $row3[0] . "&nbsp;&nbsp;|&nbsp;&nbsp;" . $row5[0] . "&nbsp;&nbsp;|&nbsp;&nbsp;" . ($row7[0]+$row8[0]+$row9[0]) . "</div></td>";
                ...
                //print "the count is " . count($res7) . "<br>";
                //for ($k = 0; $k < count($res7); $k+1) {
                //    $employee_helper_week_total = $employee_helper_week_total + $row7[$k][0];
                //    //print "the value is " . $row7[$k][0] . "<br>";
                //}
            }
