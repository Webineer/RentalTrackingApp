						...
						<?php
                                ...
                                if ($_POST['time_choice']) {
                                    if ($_POST['prod_choice'] == "all") {
                                        $sql_string_temp = "select sections.section_name, levels.level_name, sections.product_id, sections.level_id, sections.section_time_id, sections.max_seats, sections.seats_taken, section_ages.age, locations.location_name, sections.location_id, section_ages.id from sections, levels, section_ages, locations, products";
                                        $sql_string_temp .= " where sections.level_id=levels.id and sections.section_age_id=section_ages.id and sections.location_id=locations.id and sections.product_id=products.id and products.on_application='y'";
                                        $sql_string_temp .= " and sections.section_date ='" . date('Y-m-d') . "' and sections.section_time_id =" . $_POST['time_choice'];
                                        ...
                                        $sql_string_temp = "select sections.section_name, levels.level_name, sections.product_id, sections.level_id, sections.section_time_id, sections.max_seats, sections.seats_taken, section_ages.age, locations.location_name, sections.location_id, section_ages.id from sections, levels, section_ages, locations";
                                        $sql_string_temp .= " where sections.level_id=levels.id and sections.section_age_id=section_ages.id and sections.location_id=locations.id";
                                        $sql_string_temp .= " and sections.section_date ='" . date('Y-m-d') . "' and sections.product_id=" . $_POST['prod_choice'] . " and sections.section_time_id =" . $_POST['time_choice'];
